...
_PBMETA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='ps.PBMeta.customer_id', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='push', full_name='ps.PBMeta.push', index=7,
      number=5, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='simple_app', full_name='ps.PBMeta.simple_app', index=8,
...
class PBControl(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
...
_PBMETA.fields_by_name['data_type'].has_options = True
_PBMETA.fields_by_name['data_type']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
